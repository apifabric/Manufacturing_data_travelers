...
@Component({
  selector: 'DeviceAssembly-home',
  templateUrl: './DeviceAssembly-home.component.html',
  styleUrls: ['./DeviceAssembly-home.component.scss']
})
export class DeviceAssemblyHomeComponent implements AfterViewInit {
