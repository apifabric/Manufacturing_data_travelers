...
@Component({
  selector: 'ManufacturingStep-home',
  templateUrl: './ManufacturingStep-home.component.html',
  styleUrls: ['./ManufacturingStep-home.component.scss']
})
export class ManufacturingStepHomeComponent implements AfterViewInit {
