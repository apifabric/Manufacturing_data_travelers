...
@Component({
  selector: 'AdhesiveUsage-home',
  templateUrl: './AdhesiveUsage-home.component.html',
  styleUrls: ['./AdhesiveUsage-home.component.scss']
})
export class AdhesiveUsageHomeComponent implements AfterViewInit {
