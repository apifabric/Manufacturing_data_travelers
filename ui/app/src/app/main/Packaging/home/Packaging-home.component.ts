...
@Component({
  selector: 'Packaging-home',
  templateUrl: './Packaging-home.component.html',
  styleUrls: ['./Packaging-home.component.scss']
})
export class PackagingHomeComponent implements AfterViewInit {
