...
@Component({
  selector: 'Defect-home',
  templateUrl: './Defect-home.component.html',
  styleUrls: ['./Defect-home.component.scss']
})
export class DefectHomeComponent implements AfterViewInit {
