...
@Component({
  selector: 'Rework-home',
  templateUrl: './Rework-home.component.html',
  styleUrls: ['./Rework-home.component.scss']
})
export class ReworkHomeComponent implements AfterViewInit {
