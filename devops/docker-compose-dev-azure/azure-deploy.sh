...
resourcename="manufacturingdatatravelers"  # lower case, only
resourcegroup="manufacturingdatatravelers_rg"
...
# git clone https://github.com/apilogicserver/manufacturingdatatravelers.git
# cd manufacturingdatatravelers
...
az group create --name manufacturingdatatravelers_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group manufacturingdatatravelers_rg --sku S1 --is-linux
az container create --resource-group manufacturingdatatravelers_rg --name manufacturingdatatravelers --image apilogicserver/manufacturingdatatravelers:latest --dns-name-label manufacturingdatatravelers --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//manufacturingdatatravelers.westus.azurecontainer.io:5656'
